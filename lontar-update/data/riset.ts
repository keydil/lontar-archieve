...
export const publikasi: Publikasi[] = [
  {
    ...
    content: `Proses digitalisasi artefak yang rapuh seperti naskah lontar memerlukan pendekatan yang sangat berhati-hati. Metode fotogrametri yang kami terapkan menggunakan 80–120 foto per artefak dari berbagai sudut, yang kemudian diproses menggunakan perangkat lunak RealityScan untuk menghasilkan model tiga dimensi berpresisi tinggi.
