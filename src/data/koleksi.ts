...
export interface Artifact {
  ...
  year: string
  type: string
  // Kategori buat filter di halaman Koleksi. Nilainya diselaraskan dengan
  // taksonomi katalog portal utama (museumtalagamanggung.com) supaya
  // pengunjung nemu pengelompokan yang sama di dua tempat.
  category: string
  material: string
  dimensions: string
  artist: string
...
export const artifacts: Artifact[] = [
  ...
  // ── KARYA SENI DAN BUDAYA ────────────────────────────────────
  {
    ...
    name: 'Cawan Zodiak Talaga (Prasen)',
    year: '± Abad ke-13 M',
    type: 'Cawan (Wadah Air Suci)',
    category: 'Wadah Ritual',
    material: 'Perunggu',
  ...
  },
  {
    ...
    name: 'Terracotta & Keramik Kuno Talaga Manggung',
    year: 'Abad ke-13 — ke-15 M',
    type: 'Terracotta & Keramik',
    category: 'Benda Bersejarah',
    material: 'Tanah Liat Bakar (Terracotta), Keramik',
    dimensions: 'Beragam',
    artist: 'Pengrajin Kerajaan Talaga',
    country: 'Indonesia',
    address: 'Museum Talaga Manggung, Majalengka',
    location: 'Ruang Karya Seni & Budaya',
    description_id: 'Koleksi benda-benda terracotta dan pecahan keramik antik dari Kerajaan Talaga Manggung, meliputi berbagai bentuk: peralatan rumah tangga, ornamen bangunan eksterior, dan benda seremonial. Dibuat dari tanah liat pilihan yang dibakar dengan teknik tradisional. Mencerminkan kekayaan seni kriya masyarakat Talaga.',
    description_en: 'Collection of terracotta artifacts and antique ceramic sherds from the Talaga Manggung Kingdom, including household items, exterior building ornaments, and ceremonial objects. Made from selected clay fired using traditional techniques, reflecting the rich craft heritage of Talaga society.',
  ...
  {
    slug: 'goong-renteng',
    name: 'Perangkat Goong Renteng & Kenong',
    year: 'Abad ke-16 M — sekarang',
    type: 'Gamelan / Alat Musik',
    category: 'Karya Seni Budaya',
    ...
    address: 'Museum Talaga Manggung, Majalengka',
    location: 'Ruang Karya Seni & Budaya',
    description_id: 'Goong Renteng adalah salah satu bentuk gamelan tertua di Tatar Sunda. Perangkatnya terdiri atas deretan gong kecil (renteng) yang ditata pada rancak kayu, dilengkapi kenong dan gong besar sebagai penanda irama. Digunakan untuk mengiringi upacara adat dan ritual keagamaan masyarakat Talaga, dan sampai kini masih dibunyikan pada perayaan tradisi tertentu.',
    description_en: 'Goong Renteng is one of the oldest gamelan forms in the Sundanese highlands. The ensemble consists of rows of small gongs (renteng) mounted on wooden racks, accompanied by kenong and large gongs that mark the rhythmic cycle. It accompanied traditional ceremonies and religious rituals of the Talaga community, and is still played during certain traditional celebrations today.',
  ...
  {
    slug: 'baju-kere',
    name: 'Baju Kere (Zirah Baja Kuno)',
    year: 'Abad ke-14 — ke-17 M',
    type: 'Baju Zirah',
  ...
  // ── SENJATA BERLEDAK ─────────────────────────────────────────
  {
    ...
    description_id: 'Cetbang adalah meriam kecil yang digunakan armada Nusantara pada abad pertengahan, sementara rantaka merupakan meriam putar berukuran lebih besar. Koleksi keduanya di Museum Talaga Manggung mencerminkan kekuatan militer dan jaringan perdagangan kerajaan yang menghubungkan Talaga dengan dunia luar.',
    description_en: 'Cetbang are small cannons used by Nusantaran fleets in the medieval period, while rantaka are the larger swivel guns. Together, this collection at Museum Talaga Manggung reflects the military strength and trade networks connecting Talaga to the outside world.',
    thumbnail: '/images/koleksi/cetbang-talaga-01.jpg',
    media: fotos('cetbang-talaga', 5),
  },
  {
    slug: 'bedil-dorlok',
    name: 'Senapan Sulut Arquebush (Bedil Dorlok)',
    year: 'Abad ke-16 — ke-17 M',
    type: 'Senjata Berledak',
    category: 'Senjata Berledak',
    material: 'Besi Tempa, Kayu',
    dimensions: '14 unit, ukuran beragam',
    artist: 'Pengaruh Portugis / Eropa',
    country: 'Indonesia',
    address: 'Museum Talaga Manggung, Majalengka',
    location: 'Ruang Senjata',
    description_id: 'Senapan sulut (Arquebush / Bedil Dorlok) merupakan senjata api awal yang masuk ke Nusantara melalui pengaruh Portugis. Museum Talaga Manggung menyimpan 14 unit. Keberadaannya menunjukkan keterlibatan kerajaan dalam jaringan perdagangan dan konflik militer abad ke-16 dan ke-17.',
    description_en: 'The Arquebush (matchlock musket) was an early firearm introduced to the Nusantara through Portuguese influence. Museum Talaga Manggung holds 14 units. Their presence indicates the kingdom\'s involvement in 16th–17th century trade and military networks.',
